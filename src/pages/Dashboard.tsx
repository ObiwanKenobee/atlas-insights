    ...
    <AppLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          <MetricCard label="Active Scenarios" value={summary.activeScenarios} icon={<FlaskConical className="h-4 w-4" />} />
          <MetricCard label="Simulations Run" value={summary.simulationsRun} icon={<Activity className="h-4 w-4" />} />
          <MetricCard label="At-Risk Portfolios" value={summary.atRiskPortfolios} icon={<Briefcase className="h-4 w-4" />} />
          <MetricCard label="Verified Impact Assets" value={summary.verifiedImpactAssets.toLocaleString()} icon={<ShieldCheck className="h-4 w-4" />} />
          <MetricCard label="System Confidence" value={summary.systemConfidenceScore} suffix="%" icon={<Gauge className="h-4 w-4" />} />
        </div>
